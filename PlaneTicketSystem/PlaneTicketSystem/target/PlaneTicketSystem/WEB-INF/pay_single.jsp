...
<%@ page import="com.Static.Orderinfo" %>
...
<head>
    ...
    <script>
        ...
        $(function () {
            //取出结果然后进行赋值
            dep_city = '<%=((Orderinfo)request.getAttribute("order_info")).getDep_city()%>';
            arr_city = '<%=((Orderinfo)request.getAttribute("order_info")).getArr_city()%>';
            dep_date = '<%=((Orderinfo)request.getAttribute("order_info")).getDep_date()%>';
            dep_time = '<%=((Orderinfo)request.getAttribute("order_info")).getDep_time()%>';
            arr_time = '<%=((Orderinfo)request.getAttribute("order_info")).getArr_time()%>';
            dep_airport = '<%=((Orderinfo)request.getAttribute("order_info")).getDep_airport()%>';
            arr_airport = '<%=((Orderinfo)request.getAttribute("order_info")).getArr_airport()%>';
            carrier_name = '<%=((Orderinfo)request.getAttribute("order_info")).getCarrier_name()%>';
            flight_no = '<%=((Orderinfo)request.getAttribute("order_info")).getFlight_no()%>';
            seat_type = '<%=((Orderinfo)request.getAttribute("order_info")).getSeat_type()%>';
            seat_price = '<%=((Orderinfo)request.getAttribute("order_info")).getSeat_price()%>'
            psg_type='<%=((Orderinfo)request.getAttribute("order_info")).getPsg_type()%>'
            psg_name='<%=((Orderinfo)request.getAttribute("order_info")).getPsg_name()%>'
            psg_id='<%=((Orderinfo)request.getAttribute("order_info")).getPsg_id()%>'
            psg_phone='<%=((Orderinfo)request.getAttribute("order_info")).getPsg_phone()%>'
            ...
            var dep_date_time=dep_date+" "+dep_time
            var arr_date_time=dep_date+" "+arr_time
            var psg_type_name=psg_type+":"+psg_name
            total="合计:"+"<b>"+(Number(seat_price)+80).toString()+"</b>"
            seat_price="结算价："+seat_price;
            psg_id="身份证："+psg_id;
        ...
        function  pay_immediately() {
            var url="<%=basePath%>singleOrder/pay_success"
