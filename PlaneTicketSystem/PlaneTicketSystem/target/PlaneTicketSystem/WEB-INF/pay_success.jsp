...
<div class="container mar-top-10 mar-bottom-10">
    <div class="row ">
        <div class="col-md-5"> <img src="/images/logo2.png" width="210" height="70" alt="系统LOGO" class="pull-left mar-right-30">
...
<div class="container bg-white box-shadow pad-15 mar-bottom-30" style=" position:relative;">
    ...
    <div class="tishibox">
        ...
        <p>您可以继续操作：<a href="<%=basePath%>PaySuccess/Turn_to_order">[查看我的订单]</a> <a href="<%=basePath%>PaySuccess/Turn_to_single">[返回首页]</a> </p>
        <div class="img_fudong"> <a href="#"><img src="/images/chenggong2.gif" width="50" height="50" border="0" /></a></div>
